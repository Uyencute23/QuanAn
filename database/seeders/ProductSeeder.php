...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $products = [
            ...
            ['1', '4 MIẾNG GÀ RÁN KHÔNG CAY', '12000','https://jollibee.com.vn/uploads/dish/427e7a3136f84a-4mingggin.png','Được chế biến từ những miếng Gà giòn thơm, gia vị đặc trưng, và đặc biệt không cay, Gà Giòn Không Cay của KFC đã khiến các tín đồ Gà rán, đặc biệt trẻ nhỏ, mê mẩn mãi không dứt. '],
            ...
            ['1','COMBO CẶP ĐÔI VUI VẺ','135000','https://jollibee.com.vn/uploads/dish/03b21afa5ea334-149kmekong.png','Được chế biến từ những miếng Gà giòn thơm, gia vị đặc trưng, và đặc biệt không cay, Gà Giòn Không Cay của KFC đã khiến các tín đồ Gà rán, đặc biệt trẻ nhỏ, mê mẩn mãi không dứt.'],
            ...
            ['2','GÀ GIÒN + MỲ Ý + 01 NƯỚC','100000','https://jollibee.com.vn/uploads/dish/8f78c6810be7e1-2840004_jedscombo65kcompressor.png','Mì Ý sốt bò băm hay còn gọi là Spaghetti, là  là sự kết hợp hài hòa giữa sợi mì Ý không cứng và vón cục vào nhau, còn xốt bò bằm thơm phức, sánh mịn, vừa vị. có nguồn gốc từ Italia.'],
